 ...
 *--------------------------------------------------------------------------------------------*/
loadCSS('./selectBoxCustom.css', import.meta.url);
...
var SelectBoxList = /** @class */ (function () {
    function SelectBoxList(options, selected, contextViewProvider, styles) {
        this.toDispose = [];
    ...
    SelectBoxList.prototype.layoutSelectDropDown = function () {
        ...
        var statusBarHeight = dom.getTotalHeight(document.getElementById('workbench.parts.statusbar'));
        var maxSelectDropDownHeight = (window.innerHeight - selectPosition.top - selectPosition.height - statusBarHeight - SelectBoxList.SELECT_DROPDOWN_BOTTOM_MARGIN);
    ...
    SelectBoxList.SELECT_DROPDOWN_BOTTOM_MARGIN = 10;
