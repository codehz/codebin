 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
loadCSS('./snippetSession.css', import.meta.url);
...
var OneSnippet = /** @class */ (function () {
    ...
    OneSnippet.prototype.dispose = function () {
        ...
        if (this._placeholderDecorations) {
            this._editor.changeDecorations(function (accessor) { return _this._placeholderDecorations.forEach(function (handle) { return accessor.removeDecoration(handle); }); });
        }
...
var SnippetSession = /** @class */ (function () {
    ...
    SnippetSession.prototype.insert = function () {
        ...
        this._editor.setSelections(model.pushEditOperations(this._editor.getSelections(), edits, function (undoEdits) {
